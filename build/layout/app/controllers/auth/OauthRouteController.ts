...
import { OauthManager } from '@laress/core/auth';
import { Request, Response, NextFunction } from "express";
import { laress, IApplication, IUser } from "@laress/core";
import { WebRoute, Controller } from '@laress/core/controllers';
...
export class OauthRouteController extends Controller {
    ...
    public async authenticate(req: Request, res: Response, next: NextFunction) {
        ...
        let oauth: OauthManager = laress.get('oauth');
        ...
        oauth.authenticate(req, (err, access_token, refresh_token, profile) => {
            ...
            let app: IApplication = laress.get('app');
    ...
    /**
     * Handles laress oauth default routes' authorization requests.
     * 
